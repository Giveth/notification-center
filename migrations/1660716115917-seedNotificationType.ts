...
export const GivethNotificationTypes = {
    ...
    PROJECT_UNLISTED_FOR_DONORS: {
        ...
        content: 'The {project name} that you donated before is no longer visible.\n{reason}'
    },
    ...
    PROJECT_CANCELLED: {
        ...
        pushNotifierService: null,
        title: 'Project is cancelled by admin', htmlTemplate: [
            {
                "type": "p",
                "content": "The "
            },
        ...
        content: 'The {project name} project has been cancelled by admin action.\n{reason}'
    },
    PROJECT_CANCELLED_FOR_DONORS: {
        ...
        content: 'The {project name} project that you donated before has been cancelled.\n{reason}'
    },
    PROJECT_CANCELLED_FOR_USERS_WHO_LIKED: {
        ...
        content: 'The {project name} project that you liked has been cancelled.\n{reason}'
    },
    ...
    PROJECT_ACTIVATED: {
        ...
        pushNotifierService: null,
        title: 'Project is activated', htmlTemplate: [
            {
                "type": "p",
                "content": "The "
            },
    ...
    PROJECT_ACTIVATED_FOR_DONORS: {
        ...
        content: 'The {project name} project that you donated before is active now.',
    },
    ...
    PROJECT_DEACTIVATED: {
        ...
        pushNotifierService: null,
        title: 'Project is deactivated', htmlTemplate: [
            {
                "type": "p",
                "content": "The "
            },
    ...
    PROJECT_DEACTIVATED_DONORS: {
        ...
        content: 'The {project name} project that you donated before is de-actived.\n{reason}',
    },
    PROJECT_DEACTIVATED_USERS_WHO_LIKED: {
        ...
        content: 'The {project name} project that you liked is de-actived.\n{reason}',
    },
    PROJECT_VERIFIED: {
        ...
        pushNotifierService: null,
        title: 'Project verified', htmlTemplate: [
            {
                "type": "p",
                "content": "Well done! "
            },
    ...
    PROJECT_VERIFIED_DONORS: {
        ...
        content: 'The {project name} that you donated before has received verified badge!',
    },
    ...
    VERIFICATION_FORM_SENT: {
        ...
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'Form sent (Under review)', htmlTemplate: [
            {
                "type": "p",
        ...
        content: 'Hang tight! The {project name} project is currently under review.',
    },
    VERIFICATION_FORM_REJECTED: {
        ...
        pushNotifierService: null,
        title: 'Form rejected', htmlTemplate: [
            {
                "type": "p",
    ...
    REAPPLY_VERIFICATION_FORM_REMINDER: {
        ...
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'Re-apply for verification reminder', htmlTemplate: [
            {
                "type": "p",
        ...
        content: 'The verification process for {project name} project is still pending. \n[Click here] to continue.}',
    },
    CLAIM_REWARD: {
        name: 'Claim',
    ...
    REWARDS_HARVESTED: {
        ...
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'Rewards harvested', htmlTemplate: [
            {
                "type": "p",
    ...
    GIV_BACKS_ARE_READY_TO_CLAIM: {
        ...
        content: 'Your GIVbacks for round {round number} are ready to claim! \n{Click here} to take a shortcut.',
    },
    PROJECT_EDITED: {
        name: 'Project edited',
    ...
    MADE_DONATION: {
        ...
        content: 'congrats! Your donation to {project name} was successful.\nYou\'re a Giveth Donor now :)',
    },
    DONATION_RECEIVED: {
    ...
    DONATION_FAILED: {
        ...
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'Failed donation', htmlTemplate: [
            {
                "type": "p",
        ...
        content: 'Your donation to {project name} was not successful. {reason} \n{tx link}'
    },
    NEW_PROJECT_UPDATE: {
        name: 'Project update',
        ...
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'Project update', htmlTemplate: [
            {
                "type": "p",
    ...
    NEW_PROJECT_UPDATE_DONORS: {
        ...
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'Project update - Donors', htmlTemplate: [
            {
                "type": "a",
                "content": "$projectTitle",
                "href": "$projectLink"
    ...
    NEW_PROJECT_UPDATE_USERS_WHO_LIKED: {
        ...
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'Project update - Users Who Liked', htmlTemplate: [
            {
                "type": "a",
                "content": "$projectTitle",
                "href": "$projectLink"
    ...
    PROJECT_RECEIVED_LIKE: {
        ...
        category: NOTIFICATION_CATEGORY.PROJECT_RELATED,
        schemaValidator:
        SCHEMA_VALIDATORS_NAMES.PROJECT_RECEIVED_LIKE,
        emailNotifierService: THIRD_PARTY_EMAIL_SERVICES.SEGMENT,
        emailNotificationId: null,
        pushNotifierService: null,
        title: 'project liked',
