...
import {
    GetNotificationsResponse, ReadAllNotificationsResponse, ReadSingleNotificationResponse,
...
export class NotificationController {
    ...
    public async readNotification(
        ...
        try {
            validateWithJoiSchema({notificationId}, readSingleNotificationsValidator);
