...
export const SEGMENT_SCHEMA_VALIDATOR:
    ...
    projectListed: {metadata: projectTitleProjectLinkSchema, segment: projectListedSegmentValidator},
    projectUnlisted: {metadata: projectTitleProjectLinkSchema, segment: projectUnlistedSegmentValidator},
    ...
    projectUpdatedDonor: {metadata:projectTitleProjectLinkSchema, segment: projectUpdatedDonorSegmentValidator},
    projectUpdatedOwner: {metadata:projectTitleProjectLinkSchema, segment: projectUpdatedOwnerSegmentValidator},
    projectCreated: {metadata:projectTitleProjectLinkSchema, segment: projectCreatedSegmentValidator},
